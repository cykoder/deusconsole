...
Modified from the generously provided library dear imgui: https://github.com/ocornut/imgui/tree/master/examples/example_emscripten_opengl3
...
- Then build using `make` while in the `example/` directory.
